...
# Mục lục
- [1. Web cơ bản](#1)
    - [1.1. Javascript cơ bản](#javascript)
    - [1.2. HTML CSS](#html-css)
    - [1.3. NodeJs Express](#1.3)
- [2. FrontEnd Web Framework](#front-end-fw)
    - [2.1. React JS + Redux (nhiều tuyển dụng nhất)](#react-redux)
    - [2.2. Vue JS](#vuejs)
    - [2.3. Next JS](#nextjs)
    - [2.4. TypeScript](#typescript)
- [3. Database (cơ sở dữ liệu: dùng để lưu trữ trên server)](#database)
    - [3.1. SQL cơ bản](#sql)
    - [3.2. MongoDB (cơ sở dữ liệu kiểu NoSQL)](#nosql)
- [4. Nhập môn lập trình](#nhapmon)
    - [4.1. C++](#c++)
    - [4.2. C++ MFC (lập trình app giao diện Windows)](#c++mfc)
    - [4.3. C++ lập trình game](#c++game)
- [5. C#](#c#)
    - [5.1. C# cơ bản](#c-sharp1)
    - [5.2. Hướng đối tượng trong C#](#c-sharp2)
    - [5.3. C# nâng cao](#c-sharp3)
    - [5.4. C# WPF](#c-sharp4)
    - [5.5. C# Winform](#c-sharp5)
    - [5.6. ASP.NET MVC Core](#c-sharp6)
- [6. Mobile](#mobile)
    - [6.1. Swift (iOS)](#6.1)
...
- [9. Amazon Web Service ](#amazon)
- [10. Cấu trúc dữ liệu và giải thuật ](#ctdl)
- [11. Tóan rời rạc](#trr)
...
- ## <a name="1">3. Database (cơ sở dữ liệu: dùng để lưu trữ trên server) </a>

    - ### <a name="1">3.1. SQL cơ bản </a>

        https://www.youtube.com/playlist?list=PLE1qPKuGSJaDkQQB5vK7t7-PRIVjtqeHB

    - ### <a name="1">3.2. MongoDB (cơ sở dữ liệu kiểu NoSQL) </a>

        https://www.youtube.com/playlist?list=PLv6GftO355Aug0rwKfb6v96mlYrwOw7XV



- ## <a name="1">4. Nhập môn lập trình </a>
    ...
    - ### <a name="1">4.2. C++ MFC (lập trình app giao diện  Windows)</a>
    ...
    - ### <a name="1">4.3. C++ lập trình game </a>
...
- ## <a name="1">5. C# </a>
    ...
    - ### <a name="1">5.6. ASP.NET MVC Core </a>
